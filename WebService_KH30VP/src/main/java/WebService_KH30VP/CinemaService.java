 ...
 * 
 */
@WebServiceClient(name = "CinemaService", targetNamespace = "http://www.iit.bme.hu/soi/hw/SeatReservation", wsdlLocation = "WEB-INF/wsdl/SeatReservation.wsdl")
    ...
    extends Service
{
    ...
    static {
        CINEMASERVICE_WSDL_LOCATION = WebService_KH30VP.CinemaService.class.getResource("WEB-INF/wsdl/SeatReservation.wsdl");
        WebServiceException e = null;
        if (CINEMASERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'WEB-INF/wsdl/SeatReservation.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
